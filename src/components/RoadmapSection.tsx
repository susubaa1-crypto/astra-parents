    ...
    return (
        <section className="py-24 md:py-32 px-4 relative">
            <div className="max-w-[1000px] mx-auto space-y-20">
                ...
                >
                    <span className="text-[12px] font-sans uppercase tracking-[0.4em] text-sage">Vision Roadmap</span>
                ...
                <div className="relative">
                    ...
                    <div className="space-y-16">
                        {steps.map((step, idx) => (
                            ...
                            >
                                {/* Visual Node */}
                                <div className="absolute left-[2.5rem] md:left-1/2 -translate-x-1/2 flex items-center justify-center w-12 h-12 rounded-full bg-paper-cream hairline-border z-10 transition-transform duration-500 hover:scale-110">
                                    {step.icon}
                                </div>
                                ...
                                <div className="w-full md:w-1/2 pl-20 md:pl-0 flex flex-col justify-center">
                                    <div className={`p-8 hairline-border bg-paper-white transition-smooth ${step.status === 'active' ? 'border-sage shadow-sm' : ''} ${idx % 2 === 0 ? "md:mr-16" : "md:ml-16"}`}>
                                        ...
                                        {step.status === "active" && (
                                            <div className="mt-6 inline-flex items-center gap-2 text-[11px] font-sans uppercase tracking-[0.2em] text-sage border border-sage/30 px-3 py-1 rounded-full bg-sage/5">
