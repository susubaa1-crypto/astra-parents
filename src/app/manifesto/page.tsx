...
export default function ManifestoPage() {
    return (
        <main className="min-h-screen bg-[#f8f7f4] flex flex-col items-center p-8 md:p-16 lg:p-24 overflow-x-hidden">
            {/* Back Button */}
            <nav className="fixed top-8 left-8 z-10">
                <Link
                    href="/"
                    className="text-[10px] font-serif uppercase tracking-[0.4em] text-[#3a3a3a] border-b border-[#3a3a3a] pb-1 transition-all hover:tracking-[0.6em]"
                >
                    ← return to home
                </Link>
            </nav>
