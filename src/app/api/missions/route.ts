...
export async function POST(request: Request) {
  try {
    ...
    let missions = await readMissions(missionCohort);
    // Auto-clean test post generated by earlier developer curl command
    missions = missions.filter(m => !(m.name === '이현정' && m.content.includes('테스트')));
