...
const positiveData = [
  {
    ...
    words: [
      ...
      "오늘 눈을 뜨자마자 네 생각에 벌써 행복해졌어.",
      "우리 강아지 잘 잤어? 오늘 밤까지 마음껏 행복하자.",
      "오늘은 또 어떤 신나는 탐험이 우리를 기다리고 있을까?",
      "새가 짹짹 노래하는 것처럼 맑게 일어나줘서 참 고마워.",
      "마법 같은 하루가 시작됐네! 우리 기분 좋게 안아볼까?",
      "오늘 기분은 어때? 네가 있어서 온 세상이 밝아지는 것 같아.",
      "너와 함께 또 하루를 보낼 수 있다니 엄마는 정말 감사해.",
      "오늘도 엄마 옆에서 따뜻하게 아침을 맞아줘서 정말 고마워."
    ]
  },
  {
    category: "🍽️ 밥 먹을 때",
    ...
    words: [
      ...
      "이 당근이 식탁까지 오게 해 주신 농부 아저씨께 감사해.",
      "네가 맛있게 먹는 모습만 봐도 엄마는 정말 행복해.",
      "오늘 밥 먹으면서 제일 재미있었던 이야기 하나씩 해볼까?",
      "이렇게 마주 앉아서 따뜻하게 밥 먹는 이 시간이 엄만 젤 행복해.",
      "이 맛있는 고기가 뱃속에 들어가서 튼튼한 다리를 만들어주겠대!",
      "한 그릇 싹 비웠네! 네 몸이 건강해지는 소리가 들리는 것 같아.",
      "눈으로 보고 꼭꼭 씹는 맛을 느껴보며 우리 천천히 먹어볼까?",
      "맛이 어때? 이런 즐거운 표정으로 먹어주니 엄마 기분이 최고야.",
      "맛있게 먹고 우리 가족 모두 건강하자."
    ]
  },
  {
    category: "👟 외출할 때",
  ...
  },
  {
    ...
    words: [
      ...
      "눈을 편안하게 감고, 오늘 우리를 미소 짓게 했던 것들을 하나씩 떠올려보자.",
